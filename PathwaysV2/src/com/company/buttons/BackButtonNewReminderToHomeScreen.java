...
public class BackButtonNewReminderToHomeScreen extends JButton{


        // Build the button in the constructor.
        private BackButtonNewReminderToHomeScreen() {
            this.setText("<- Back");
            this.setSize(190, 30);
        ...
        private static final com.company.buttons.BackButtonNewReminderToHomeScreen instance = new com.company.buttons.BackButtonNewReminderToHomeScreen();
        ...
        public static com.company.buttons.BackButtonNewReminderToHomeScreen getBackButtonNewReminderToHomeScreenInstance() {
            return instance;
        }
        ...
        private void returnToHome(){
            ...
            mainPanelInstance.remove(AddReminderScreen.getAddReminderScreenInstance());
